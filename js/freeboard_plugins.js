...
DeveloperConsole = function(theFreeboardModel) {
    function showDeveloperConsole() {
        ...
        table.append($('<thead style=""><tr><th>آدرس اسکریپت پلاگین</th></tr></thead>'));

        var tableBody = $("<tbody></tbody>");

        table.append(tableBody);

        container.append($("<p>در اینجا شما می‌توانید به اسکریپ‌های دیگر برای بارگزاری منبع اطلاعات یا ابزارک‌ها ارجاع دهید.</p>"))
            .append(table)
            .append(addScript)
        ...
        new DialogBox(container, "کنسول توسعه‌دهنده", "باشه", null, function() {
...
function FreeboardModel(datasourcePlugins, widgetPlugins, freeboardUI) {
    ...
    this.loadDashboardFromLocalFile = function() {
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            alert('سیستم موفق به بارگزاری فایل در براوزر نشد.');
        }
    }
...
JSEditor = function() {
    ...
    function displayJSEditor(value, callback) {
        ...
        var closeButton = $('<span id="dialog-cancel" class="text-button">بستن</span>').click(function() {
            if (callback) {
...
PluginEditor = function(jsEditor, valueEditor) {
    ...
    function createPluginEditor(title, pluginTypes, currentTypeName, currentSettingsValues, settingsSavedCallback) {
                    ...
                    case "array":
                        {
                            ...
                            $('<div class="table-operation text-button">اضافه کردن</div>').appendTo(valueCell).click(function() {
                    ...
                    case "boolean":
                        {
                            ...
                            var onOffSwitch = $('<div class="onoffswitch"><label class="onoffswitch-label" for="' + settingDef.name + '-onoff"><div class="onoffswitch-inner"><span class="off">خیر</span><span class="on">بله</span></div><div class="onoffswitch-switch"></div></label></div>').appendTo(valueCell);
                    ...
                    default:
                        {
                            ...
                            if (settingDef.type == "calculated") {
                                ...
                                if (settingDef.multi_input) {
                                    var inputAdder = $('<ul class="board-toolbar"><li class="add-setting-row"><i class="icon-plus icon-white"></i><label>اضافه کردن</label></li></ul>')
                                        .mousedown(function(e) {
                                            e.preventDefault();
        ...
        new DialogBox(form, title, "ذخیره", "انصراف", function() {
            ...
            for (var index = 0; index < selectedType.settings.length; index++) {
                ...
                if (settingDef.required && (_.isUndefined(newSettings.settings[settingDef.name]) || newSettings.settings[settingDef.name] == "")) {
                    _displayValidationError(settingDef.name, "این فیلد اجباری است.");
                    return true;
                } else if (settingDef.type == "integer" && (newSettings.settings[settingDef.name] % 1 !== 0)) {
                    _displayValidationError(settingDef.name, "باید یک نوع عددی باشد.");
                    return true;
                } else if (settingDef.type == "number" && !_isNumerical(newSettings.settings[settingDef.name])) {
                    _displayValidationError(settingDef.name, "حتما باید عدد باشد.");
                    return true;
                }
            }
        ...
        if (pluginTypeNames.length > 1) {
            var typeRow = createSettingRow("plugin-types", "نوع");
            typeSelect = $('<select></select>').appendTo($('<div class="styled-select"></div>').appendTo(typeRow));

            typeSelect.append($("<option>یکی را انتخاب کنید...</option>").attr("value", "undefined"));
...
var freeboard = (function() {
    ...
    var currentStyle = {
        values: {
            "font-family": '"Sahel", "Helvetica Neue Ultra Light", "Helvetica Neue", sans-serif',
            "color": "#d3d4d4",
            "font-weight": 100
        }
    };
        ...
        init: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            $(element).click(function(event) {
                if (options.operation == 'delete') {
                    var phraseElement = $('<p>آیا مطمئید از حذف  ' + title + '?</p>');
                    new DialogBox(phraseElement, "تاييد", "بله", "خیر", function() {
    ...
    return {
        ...
        setDatasourceSettings: function(datasourceName, settings) {
            ...
            if (!datasource) {
                console.log("منبع اطلاعات پیدا نشد.");
                return;
            }
...
(function() {
    ...
    freeboard.loadDatasourcePlugin({
        ...
        settings: [{
            ...
            name: "use_thingproxy",
            display_name: "تلاش برای thingproxy",
            description: 'ابتدا سیستم تلاش می‌کند تا ارتباط کانکشن JSON را برقرار کند، در صورت شکست کانکشن JSONP و اگر باز هم موفق نشد، شما می‌توانید از thingproxy استفاده کنید. <a href="https://github.com/Freeboard/thingproxy" target="_blank">اطلاعات بیشتر</a>.',
            type: "boolean",
            default_value: true
        }, {
            name: "refresh",
            display_name: "بازسازی مجدد، هر",
            type: "number",
            suffix: "ثانیه",
            default_value: 5
        }, {
            ...
            name: "body",
            display_name: "پارامترها",
            type: "text",
            description: "معمولا فقط برای درخواست‌های POST استفاده می‌شود."
        }, {
            name: "headers",
            display_name: "هدر‌ها",
            type: "array",
    ...
    freeboard.loadDatasourcePlugin({
        ...
        settings: [{
            ...
            type: "text",
            description: "API شخصی شما از Open Weather Map"
        }, {
            name: "location",
            display_name: "مکان",
            type: "text",
            description: "به طور مثال: London, UK"
        }, {
            name: "units",
            display_name: "واحد",
            type: "option",
    ...
    freeboard.loadDatasourcePlugin({
        ...
        "settings": [{
            name: "thing_id",
            display_name: "نام Thing",
            "description": "به طور مثال: salty-dog-1",
            type: "text"
        }],
        newInstance: function(settings, newInstanceCallback, updateCallback) {
    ...
    freeboard.loadDatasourcePlugin({
        ...
        "settings": [{
            "name": "datafile",
            "display_name": "آدرس فایل",
            "type": "text",
            "description": "آدرس یک فایل JSON که در آن لیستی از فایل‌ها وجود دارد."
        }, {
            name: "is_jsonp",
            display_name: "JSONP",
            type: "boolean"
            ...
            "display_name": "بازپخش",
            "type": "boolean",
            "description": "پخش مجددا پس از اتمام فایل"
        }, {
            "name": "refresh",
            "display_name": "بازسازی مجدد، هر",
            "type": "number",
    ...
    freeboard.loadDatasourcePlugin({
        ...
        "settings": [{
                ...
                "description": "مقدار UUID دستگاه شما",
                ...
                // **description** : Text that will be displayed below the setting to give the user any extra information.
                "description": "مقدار توکن دستگاه شما",
                // **required** : Set to true if this setting is required for the datasource to be created.
                "required": true
            }, {
                // **name** (required) : The name of the setting. This value will be used in your code to retrieve the value specified by the user. This should follow naming conventions for javascript variable and function declarations.
...
(function() {
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [{
            ...
            name: "sparkline",
            display_name: "به همراه Sparkline",
            type: "boolean"
        }, {
            name: "animate",
            display_name: "نمایش گرافیکی تغییرات",
            type: "boolean",
            default_value: true
        }, {
            name: "units",
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [{
            ...
            name: "include_legend",
            display_name: "نمایش علائم",
            type: "boolean"
        }, {
            name: "legend",
            display_name: "علائم",
            type: "text",
            description: "در صورت استفاده از چند  sparklines، آنها را با کاما از هم جدا کنید."
        }],
        newInstance: function(settings, newInstanceCallback) {
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [{
            ...
            display_name: "جهت",
            type: "calculated",
            description: "با واحد درجه"
        }, {
            name: "value_text",
            display_name: "مقدار نوشته",
            type: "calculated"
        }, {
            name: "units",
            display_name: "واحد",
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [{
            ...
            "name": "refresh",
            "suffix": "ثانیه",
            "description": "اگر تصویر شما ثابت است، این فیلد را خالی بگذارید."
        }],
        newInstance: function(settings, newInstanceCallback) {
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [{
            ...
            name: "on_text",
            display_name: "نوشته هنگام روشن بودن",
            type: "calculated"
        }, {
            name: "off_text",
            display_name: "نوشته موقع خاموشی",
            type: "calculated"
        }],
        newInstance: function(settings, newInstanceCallback) {
    ...
    freeboard.loadWidgetPlugin({
        ...
        display_name: "نقشه گوگل",
        fill_size: true,
        settings: [{
            name: "lat",
            display_name: "عرض جفرافیایی",
            type: "calculated"
        }, {
            name: "lon",
    ...
    freeboard.loadWidgetPlugin({
        "type_name": "html",
        "display_name": "صفحه HTML",
        "fill_size": true,
        "settings": [{
            "name": "html",
            "display_name": "صفحه HTML",
            "type": "calculated",
            "description": "می‌تواند یک صفحه HTML و یا یک اسکریپت جاوااسکریپت که خروجی HTML می‌دهد باشد.."
        }, {
            "name": "height",
            "display_name": "ارتفاع سند",
            "type": "number",
            "default_value": 4,
            "description": "ارتفاع سند چیزی حدود 60پیکسل"
        }],
        newInstance: function(settings, newInstanceCallback) {
